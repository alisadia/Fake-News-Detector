...
openai.api_key = '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'
...
def predict():
    if request.method == 'POST':
        ...
        answer = [answer]
        print(answer)
        probabilit= find_probability(prompt, answer)
        probability=numpy.round(probabilit,4)
        print(probability)
        return render_template('predictinfo.html', prompt=prompt,probability=probability, answer=answer)
